...
class Db_Mongodb_Collection_Document
{
    /**
    ...
    public function __construct(array $config = array())
    {
        ...
        if (isset($config['data'])) {
            if (!is_array($config['data'])) {
                ...
                throw new Db_Mongodb_Collection_Exception('Data must be an array');
            }
    ...
    protected function _transformColumn($columnName)
    {
        if (!is_string($columnName)) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception('Specified column is not a string');
        }
    ...
    public function __get($columnName)
    {
        ...
        if (!array_key_exists($columnName, $this->_data)) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception("Specified column \"$columnName\" is not in the row");
        }
    ...
    public function __unset($columnName)
    {
        ...
        if ($this->isConnected() && in_array($columnName, $this->_collection->info('primary'))) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception("Specified column \"$columnName\" is a primary key and should not be unset");
        }
    ...
    public function setCollection(Db_Mongodb_Collection_Abstract $collection = null)
    {
        ...
        if (! $collection instanceof $this->_collectionClass) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception("The specified Table is of class $collectionClass, expecting class to be instance of $this->_collectionClass");
        }
...
//        }
        ...
        if (! array_intersect((array) $this->_primary, $info['primary']) == (array) $this->_primary) {
            ...
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception("The specified Table '$collectionClass' does not have the same primary key as the Row");
        }
    ...
    protected function _doInsert()
    {
        ...
        if ($this->_readOnly === true) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception('This row has been marked read-only');
        }
...
//        }
    ...
    protected function _getCollection()
    {
        if (!$this->_connected) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception('Cannot save a Row unless it is connected');
        }
        return $this->_collection;
    }
    ...
    protected function _getPrimaryKey($useDirty = true)
    {
        if (!is_array($this->_primary)) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception("The primary key must be set as an array");
        }
        ...
        if (count($primary) != count($array)) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception("The specified Table '$this->_collectionClass' does not have the same primary key as the Row");
        }
        return $array;
    }
    ...
    protected function _refresh()
    {
        ...
        if (null === $row) {
            require_once 'Db/Mongodb/Collection/Exception.php';
            throw new Db_Mongodb_Collection_Exception('Cannot refresh row as parent is missing');
        }
...
//        }
        ...
        require_once 'Db/Mongodb/Collection/Exception.php';
        throw new Db_Mongodb_Collection_Exception("Unrecognized method '$method()'");
    }
    ...
    protected function _getCollectionFromString($collectionName)
    {
        ...
        if (!class_exists($collectionName)) {
            try {
                ...
                require_once 'Db/Mongodb/Collection/Exception.php';
                throw new Db_Mongodb_Collection_Exception($e->getMessage(), $e->getCode(), $e);
            }
        }
