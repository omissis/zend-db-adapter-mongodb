<?php
class Zend_Db_Adapter_MongoDB_Collection_Documentset implements SeekableIterator, Countable, ArrayAccess
{
    /**
    ...
    public function seek($position)
    {
        ...
        if ($position < 0 || $position >= $this->_count) {
            throw new Zend_Db_Adapter_MongoDB_Collection_Exception("Illegal index $position");
        }
    ...
    public function getDocument($position, $seek = false)
    {
        ...
        try {
            ...
            throw new Zend_Db_Adapter_MongoDB_Collection_Exception('No row could be found at position ' . (int) $position, 0, $e);
        }
        if ($seek == false) {
            $this->seek($key);
        }
